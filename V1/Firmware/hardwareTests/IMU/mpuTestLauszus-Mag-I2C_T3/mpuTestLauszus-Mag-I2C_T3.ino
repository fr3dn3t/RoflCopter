...
//Mittlaufende Mittel
  ...
  //comp
  int compAngleBufferSize = 2;
  double compBufferX[2];
  double compBufferY[2];
  int compBufferCounter = 0;
  double compAngleXBuffered, compAngleYBuffered;

  //final
  int finalAngleBufferSize = 2;
  double finalBufferX[2];
  double finalBufferY[2];
