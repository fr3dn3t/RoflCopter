...
//Mittlaufende Mittel
  ...
  double kalAngleXBuffered, kalAngleYBuffered, kalAngleZBuffered;
...
void loop() {
  ...
  //KalZ
  kalBufferZ[kalBufferCounter] = round(kalAngleZ);
  kalAngleZBuffered = 0;
  for(i=0; i<kalAngleBufferSize; i++) {
    kalAngleZBuffered = kalAngleZBuffered+kalBufferZ[i]; 
  }
  kalAngleZBuffered = kalAngleZBuffered/kalAngleBufferSize;
 ...
 Serial.print(round(kalAngleXBuffered)); Serial.print("\t");
  ...
  Serial.print(round(kalAngleZBuffered)); Serial.print("\t");
