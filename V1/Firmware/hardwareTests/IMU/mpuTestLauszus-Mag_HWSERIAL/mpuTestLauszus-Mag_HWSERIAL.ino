...
void loop() {
  ...
  double kalBufferX[6] = {0,0,0,0,0,0};
  double kalBufferY[6] = {0,0,0,0,0,0};
  ...
  //final
  int finalAngleBufferSize = 3;
  double finalBufferX[3] = {0,0,0};
  double finalBufferY[3] = {0,0,0};
  ...
  //KalX
  kalBufferX[kalBufferCounter] = kalAngleX;
  kalAngleXBuffered = 0;
  ...
  //KalY
  kalBufferY[kalBufferCounter] = kalAngleY;
  kalAngleYBuffered = 0;
  for(i=0; i<kalAngleBufferSize; i++) {
  ...
  //CompX
  compBufferX[compBufferCounter] = compAngleX;
  ...
  //CompY
  compBufferY[compBufferCounter] = compAngleY;
  ...
  finalBufferX[finalBufferCounter] = ((kalAngleXBuffered*1.4+compAngleXBuffered*1.2)/2)*3;
  finalX = 0;
  for(i=0; i<finalAngleBufferSize; i++) {
    finalX = finalX+finalBufferX[i]; 
  }
  finalX = finalX/finalAngleBufferSize;

  //finalY
  finalBufferY[finalBufferCounter] = ((kalAngleYBuffered*1.4+compAngleYBuffered*1.2)/2)*3;
  finalY = 0;
  for(i=0; i<finalAngleBufferSize; i++) {
  ...
  HWSERIAL.print(finalX); HWSERIAL.print("\t");
  HWSERIAL.print(finalY); HWSERIAL.print("\t");
  /*
